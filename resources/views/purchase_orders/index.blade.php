            ...
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-head">
                        ...
                        <h1 class="pull-right">
                            <a class="btn btn-primary pull-right ml-2" style="margin-top: 8px;margin-bottom: 5px" href="{{ route('purchase_orders.create') }}">Add New</a>
                        </h1>
                    </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        function change_status(object){
            ...
            if (confirm(msg)) {
                $.ajax({
                    "url": "{!! route('purchase_orders.change.status') !!}",
                    "dataType": "json",
                    "type": "POST",
                    "data":{
                        id: id,
