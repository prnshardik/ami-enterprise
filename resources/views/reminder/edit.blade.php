    ...
    <div class="page-content fade-in-up">
        <div class="row">
            <div class="col-md-12">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Edit Reminders</div>
                    </div>
                    <div class="ibox-body">
                        <form name="form" action="{{ route('reminders.update') }}" id="form" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text"  name="date_time" id="date_time" class="form-control" placeholder="Plese enter date_time" value="{{ date('m-d-Y H:i:A', strtotime($data->date_time)) ??'' }}" />
                                    <span class="kt-form__help error date_time"></span>
                                </div>
                                <div class="form-group col-sm-12">
                                    <label for="note">Description <span class="text-danger"></span></label>
                                    <textarea name="note" id="note" class="form-control"  placeholder="Plese enter note" cols="30" rows="10">{{ $data->note?? '' }}</textarea>
